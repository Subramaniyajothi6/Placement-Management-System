...
/*************  ✨ Windsurf Command ⭐  *************/
        /**
         * Resets the selected interview to null
         * @param {Object} state - The current state of the slice
         */
/*******  01820d27-c7a3-45ae-ad08-8bd507a870a0  *******/
...
export const { clearInterviewError, clearSelectedInterview } = interviewSlice.actions;

export const selectAllInterviews = (state) => state.interview.interviews;
export const selectInterviewById = (state) => state.interview.interview;
...
export const selectInterviewsByStudent = (state, studentId) =>
    state.interview.interviews.filter((i) =>
